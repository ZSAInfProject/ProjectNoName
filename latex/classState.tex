...
\hypertarget{classState_af989800e12898aea96188086e9fd649d}{\index{State@{State}!render@{render}}
...
)\hspace{0.3cm}{\ttfamily [pure virtual]}}}\label{classState_af989800e12898aea96188086e9fd649d}


Function called every screen refresh. 

\hyperlink{classState_af989800e12898aea96188086e9fd649d}{render()} is called every screen refresh. Should be used for rendering. 
...
Implemented in \hyperlink{classGameState_aa4061260f4ca0acc7d1833dbb6691f0f}{Game\-State}.
...
\hyperlink{classState_a1cdec36e9ffad91ba7af560770601017}{tick()} is called periodically. Period is set in \hyperlink{classGame}{Game} singleton. Can be used for stuff that doesn't need to run very often, for example recalculating A\-I path. 
